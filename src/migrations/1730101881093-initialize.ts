...
export class Initialize1730101881093 implements MigrationInterface {
    name = 'Initialize1730101881093'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "observer_accounts" ("address" character varying NOT NULL, "name" character varying NOT NULL, "lastTxLt" character varying NOT NULL, "lastTxHash" character varying NOT NULL, "stopped" boolean NOT NULL, CONSTRAINT "PK_4d1a97300f11002db28cba3fac4" PRIMARY KEY ("address"))`);
